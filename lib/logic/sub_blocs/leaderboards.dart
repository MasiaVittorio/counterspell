...
import 'package:counter_spell/widgets/alerts/specifics/leaderboards/history/winner_selector.dart';
import 'package:counter_spell/widgets/alerts/specifics/leaderboards/stats/commanders/model_simple.dart';
import 'package:counter_spell/widgets/alerts/specifics/leaderboards/stats/players/model_simple.dart';
...
class CSPastGames {
  ...
  bool saveGame(
    ...
    final pastGame = PastGame.fromState(
      state.frozen,
    ...
    if (!avoidPrompt &&
        parent.payments.unlocked.value &&
        pastGame.winner == null) {
