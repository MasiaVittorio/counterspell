...
class QuantityAchievement extends Achievement {
  ...
  const QuantityAchievement(
    ...
    required super.targetBronze,
    required super.targetSilver,
    required super.targetGold,
  });
  ...
  QuantityAchievement incrementBy(int by) =>
      withCount((count! + by).clamp(0, targetGold));
  ...
  factory QuantityAchievement.fromJson(dynamic json) => QuantityAchievement(
        json["shortTitle"],
        title: json["title"],
        text: json["text"],
...
class QualityAchievement extends Achievement {
  ...
  QualityAchievement get reset => withTargets(<String, bool>{
        for (final entry in targets.entries) entry.key: false,
      });

  QualityAchievement withTargets(Map<String, bool> newTargets) =>
      QualityAchievement(
        shortTitle,
        title: title,
        text: text,
  ...
  factory QualityAchievement.fromJson(dynamic json) => QualityAchievement(
        json["shortTitle"],
        title: json["title"],
        text: json["text"],
        targets: <String, bool>{
