...
class GameState {
  ...
  factory GameState.fromJson(Map<String, dynamic> json) => GameState(players: {
  ...
  factory GameState.start(
    ...
    Set<String> counters, {
    int startingLife = 20,
    Map<String, CommanderSettings>? settingsPartnersA =
        const <String, CommanderSettings>{},
    Map<String, CommanderSettings>? settingsPartnersB =
        const <String, CommanderSettings>{},
      ...
      GameState(players: {
        for (final name in names)
          name: Player.start(
            ...
            settingsPartnerA:
                settingsPartnersA != null ? settingsPartnersA[name] : null,
            settingsPartnerB:
                settingsPartnersB != null ? settingsPartnersB[name] : null,
          ),
      });
  ...
  int get historyLenghtSafe {
    ...
    final ls = [
      for (final player in players.values) player.states.length,
    ];
  ...
  void applyAction(GameAction action) => action.applyTo(this);
