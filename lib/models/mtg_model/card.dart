...
class MtgCard {
  ...
  bool operator ==(Object other) {
    ...
    if (other is! MtgCard) return false;
    return other.id == id;
  }
  ...
  factory MtgCard.fromJson(Map<String, dynamic> json) => MtgCard(
        ...
        colors: json["colors"] == null
            ? null
            : List<MtgColor>.from(
                json["colors"].map((x) => colorValues.map[x])),
        colorIdentity: List<MtgColor>.from(
            json["color_identity"].map((x) => colorValues.map[x])),
        legalities: <String, String>{
          for (final entry
              in ((json["legalities"] ?? <String, String>{}) as Map).entries)
        ...
        watermark: json["watermark"] == null
            ? null
            : watermarkValues.map[json["watermark"]],
        allParts: json["all_parts"] == null
            ? null
            : List<MtgRelatedCard>.from(
                json["all_parts"].map((x) => MtgRelatedCard.fromJson(x))),
        ...
        colorIndicator: json["color_indicator"] == null
            ? null
            : List<MtgColor>.from(
                json["color_indicator"].map((x) => colorValues.map[x])),
        prices:
            json["prices"] == null ? null : MtgPrices.fromJson(json["prices"]),
        purchaseUris: json["purchase_uris"] == null
            ? null
            : MtgPurchaseUris.fromJson(json["purchase_uris"]),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "color_identity": List<dynamic>.from(
        ...
        "arena_id": arenaId,
        "watermark":
            watermark == null ? null : watermarkValues.reverse[watermark!],
        "all_parts": allParts == null
            ? null
            : List<dynamic>.from(allParts!.map((x) => x.toJson())),
        ...
        "color_indicator": colorIndicator == null
            ? null
            : List<dynamic>.from(
                colorIndicator!.map((x) => colorValues.reverse[x])),
...
class MtgPurchaseUris {
  ...
  factory MtgPurchaseUris.fromJson(Map<String, dynamic> json) =>
      MtgPurchaseUris(
...
final allPartObjectValues =
    EnumValues({"related_card": AllPartObject.RELATED_CARD});
...
final cardFaceObjectValues =
    EnumValues({"card_face": CardFaceObject.CARD_FACE});
...
final gameValues =
    EnumValues({"arena": Game.ARENA, "mtgo": Game.MTGO, "paper": Game.PAPER});

enum CardObject { CARD }

final dbObjectValues = EnumValues({"card": CardObject.CARD});
...
class EnumValues<T> {
  ...
  Map<T, String> get reverse {
    _reverseMap ??= <T, String>{
      for (final entry in map.entries) entry.value: entry.key
    };
    return _reverseMap!;
  }
}
