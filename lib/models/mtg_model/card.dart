...
class MtgCard {
  ...
  String imageUrl({int faceIndex = 0, String uri: "artCrop"}) {
    ...
    return {
      ...
      "normal": uris.normal,
      "png": uris.png,
      "artCrop": uris.artCrop,
      "borderCrop": uris.borderCrop,
    }[uri];
  }
  ...
  //     if(this.isType(type))
  //       return ManaIcons.basicTypes[type];
    
  //   return McIcons.cards_outline;
  // }
  ...
  // IconData get watermarkIcon {
  //   return ManaIcons.watermarks[watermark];
  // }

  // IconData get setIcon {
  //   return Keyrune.sets[this.dbSet];
  // }
  ...
  //       break;
  //     case 1:
  //       return [MANA_COLORS_BKG[_clrs[0]]];
  //       break;
  //     case 2:
  //       if(isHybrid(face)) return [
  //         MTG_TO_COLORS_BKG[_clrs[0]],
  ...
  //   return [GOLD_MULTICOLOR];
  // } 
  // Color singleBkgColorMana([int face = 0]){
  //    final cc = bkgColorsMana(face);
  ...
  // }
    ...
    factory MtgCard.fromJson(Map<String, dynamic> json) => MtgCard(
        ...
        mtgoId: json["mtgo_id"] == null ? null : json["mtgo_id"],
...
class Legalities {
    ...
    factory Legalities.fromJson(Map<String, dynamic> json) => Legalities(
        standard: commanderValues.map[json["standard"]],
        future: commanderValues.map[json["future"]],
        frontier: commanderValues.map[json["frontier"]],
        modern: commanderValues.map[json["modern"]],
        legacy: commanderValues.map[json["legacy"]],
        pauper: commanderValues.map[json["pauper"]],
        vintage: commanderValues.map[json["vintage"]],
        penny: commanderValues.map[json["penny"]],
        commander: commanderValues.map[json["commander"]],
        duel: commanderValues.map[json["duel"]],
        oldschool: commanderValues.map[json["oldschool"]],
    );
...
enum Legality { NOT_LEGAL, LEGAL, BANNED, RESTRICTED }

final commanderValues = EnumValues({
