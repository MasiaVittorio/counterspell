...
class KrarkAndSakashima extends GenericAlert {
  ...
  const KrarkAndSakashima({super.key})
      : super(
          700,
          _title,
...
class _KrarkAndSakashimaState extends State<_KrarkAndSakashima> {
  ...
  void autoSolveTrigger() {
    ...
    _Flip choice;
    if (spellPlace == _Zone.hand) {
      /// If already bounced, try to copy
      ...
      /// If still on the stack, try to bounce
  ...
  bool get canCast => mana >= spell.cost && spellPlace == _Zone.hand;
                  ...
                  Expanded(
                    ...
                    child: SubSection(
                      (() {
                        ...
                        return <Widget>[
                          SectionTitle(
                              "Trigger #${triggers.length} ${howManyThumbs > 0 ? "($howManyThumbs thumbs)" : "(regular flip)"}"),
                          if (howManyFlips > 1)
                            ButtonTilesRow(
                              children: <Widget>[
                                ButtonTile.transparent(
                            ...
                            ButtonTilesRow(
                              children: <Widget>[
                                ...
                                ButtonTile.transparent(
                                  ...
                                  onTap: () => solveTrigger(flips.first,
                                      automatic: false),
                                  text:
    ...
    return Column(
      ...
      children: [
        ...
        SwitchListTile(
          ...
          onChanged: (howManyKrarks > 1 && canCast)
              ? (v) => setState(() {
                    keepBouncing = v;
                  })
              : null,
...
class _Spell {
  ...
  ///spells that not always resolve
...
class _ThumbTrigger {
  ...
  _ThumbTrigger(int howManyThumbs, Random? rng)
      : flips = [
