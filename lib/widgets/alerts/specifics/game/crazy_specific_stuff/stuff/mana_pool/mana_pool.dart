...
class __ManaPoolState extends State<_ManaPool>
  ...
  Widget get recentActions => logic.history.build(
        (context, history) => logic.show.build(
          (_, show) => SizedBox(
        ...
        SizedBox(
          ...
          child: Stack(
            ...
            children: [
              Icon(
                action.color.icon,
                color: action.color.color.withValues(alpha: 0.4),
                size: 35,
              ),
              Center(
                child: Text(
      ...
      builder: (_, constraints) => ConstrainedBox(
        ...
        child: VelocityPanDetector(
          ...
          onPanUpdate: (details) {
            ...
            onPan(color);
            scroller!
                .onDragUpdate(details, constraints.maxWidth, vertical: false);
          },
          child: scroller!.isScrolling.build(
            (_, scrolling) => scroller!.intValue.build(
              (_, increment) {
                          ...
                          child: Center(
                            child: CircleNumber(
                              ...
                              extraIcon: Icon(
                                color.icon,
                                color:
                                    color.color.contrast.withValues(alpha: 0.1),
