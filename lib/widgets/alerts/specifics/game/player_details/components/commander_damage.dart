  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: bloc.themer.buildFromDefenceColor(
        (_, defenceColor) => BlocVar.build5<
          Map<CSPage,Color>?, List<String>,
                  ...
                  if(player.havePartnerB)
                    ListTile(
                      ...
                      trailing: Text(
                        ...
                        style: textTheme.bodyLarge!.copyWith(color: attackColor),
                      ),
                    ...
                    if(gameState.players[otherName]!.havePartnerB)
                        ListTile(
                          ...
                          trailing: Text(
                            ...
                            style: textTheme.bodyLarge!.copyWith(color: defenceColor),
                          ),
