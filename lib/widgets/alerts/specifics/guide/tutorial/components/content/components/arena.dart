...
class TutorialArena extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: <Widget>[
        const _Text(
            "There is a streamlined, more traditional mode you can use."),
        Expanded(
            child: Stack(
          fit: StackFit.expand,
          children: <Widget>[
        ...
        const _Text(
            "But most of the advanced capabilities are offered by the main mode."),
