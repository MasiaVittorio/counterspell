...
class _TutorialPagesState extends State<TutorialPages> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle subheadBold =
        subhead.copyWith(fontWeight: subhead.fontWeight!.increment.increment);

    final double collapsedPanelSize =
        stage.dimensionsController.dimensions.value.collapsedPanelSize;

    return Column(
      children: <Widget>[
        SubSection.withoutMargin(
          <Widget>[
            Row(
              children: <Widget>[
                Expanded(
  ...
  Widget bottomBar(Map<CSPage, Color?>? colors, double collapsedPanelSize,
          ThemeData theme) =>
      FakeBottomBar(
