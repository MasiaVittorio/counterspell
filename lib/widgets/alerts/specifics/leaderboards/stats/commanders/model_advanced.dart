...
class CommanderGame {
  ...
  int? damageByPilot(String? pilot) =>
      pilot == null ? averageDamage : damage[pilot];
  int? castsByPilot(String? pilot) =>
      pilot == null ? averageCasts : casts[pilot];
}
...
class CommanderStatsAdvanced extends CommanderStats {
  ...
  //================================
  // Constructor(s)
  const CommanderStatsAdvanced(
    super.card, {
    required super.wins,
    required super.games,
    required super.totalDamage,
    required super.totalCasts,
  ...
  factory CommanderStatsAdvanced.fromPastGames(
    ...
    return CommanderStatsAdvanced(
      ...
      groupSizes: <int>{
        for (final g in games) g.groupSize,
      },
      pilots: <String>{
        for (final g in games) ...g.pilots,
      },
    );
  }
}
