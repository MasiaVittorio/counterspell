...
class Players extends StatefulWidget {
  ...
  const Players(this.stat, {super.key});
...
class _PlayersState extends State<Players> {
  ...
  Widget build(BuildContext context) {
    ...
    final list = [...stat.playersApplicable.entries]..sort((e1, e2) => absolute
        ? e2.value.compareTo(e1.value)
        : (e2.value / mapTotals[e2.key]!)
            .compareTo(e1.value / mapTotals[e1.key]!));
