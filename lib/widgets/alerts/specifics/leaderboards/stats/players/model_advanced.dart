...
class PlayerGame {
  ...
  bool playedCommander(String oracleIds) =>
      commandersOracleIds.contains(oracleIds);
...
class PlayerStatsAdvanced extends PlayerStats {
  ...
  int _totalFilter({
    ...
    for (final game in playerGames) {
      if (commanderOracleId == null ||
          game.playedCommander(commanderOracleId)) {
  ...
  factory PlayerStatsAdvanced.fromPastGames(
    ...
    return PlayerStatsAdvanced(
      ...
      opponents: <String>{
        for (final g in games) ...g.opponents,
      },
