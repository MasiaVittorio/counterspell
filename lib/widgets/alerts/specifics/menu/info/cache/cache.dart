      ...
      child: Column(children: <Widget>[
        Section(<Widget>[
          ...
          ListTile(
            ...
            subtitle: const Text(
                "This will delete all the cached image files you used for the players' backgrounds"),
        ...
        Section(<Widget>[
          ...
          const ListTile(
            title: Text(
                "Every time you select a card as your commander, you will find it promped as an auto-suggestion in your next searches for that player. All those cards are stored in your memory as text (independent from the cached images, so they don't use up much space), but you can delete them if you want."),
          ),
          Padding(
            ...
            child: Row(
              ...
              Expanded(
                ...
                onTap: () => stage!.showAlert(const SavedCardsCache(),
                    size: SavedCardsCache.height),
              )),
...
class SavedCardsCache extends StatelessWidget {
  const SavedCardsCache({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return RadioHeaderedAlert<bool>(
      initialValue:
          stage.panelController.alertController.savedStates[pageKey] ?? true,
      onPageChanged: (p) =>
