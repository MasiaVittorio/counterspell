...
class CachePlayer extends StatelessWidget {
  final String player;
  const CachePlayer(this.player, {super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return HeaderedAlert(
      ...
      child: bloc.game.gameGroup.savedCards.build(
        (_, map) {
          final List<MtgCard> cards = <MtgCard>[...map[player]!];
                ...
                trailing: IconButton(
                  ...
                  onPressed: () => stage.showAlert(
                    ConfirmAlert(
                      ...
                      action: () {
                        bloc.game.gameGroup.savedCards.value[player]!
