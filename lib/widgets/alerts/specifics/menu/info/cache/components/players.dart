...
class CachePlayers extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return bloc.game.gameGroup.savedCards.build(
      (_, cards) {
              ...
              trailing: IconButton(
                ...
                onPressed: () => stage.showAlert(
                  ConfirmAlert(
                    ...
                    action: () =>
                        bloc.game.gameGroup.savedCards.removeKey(player),
                  ),
                  size: ConfirmAlert.height,
                ),
              ),
              onTap: () => stage.showAlert(CachePlayer(player),
                  size: CachePlayer.height),
            );
          },
