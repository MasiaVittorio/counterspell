        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            FloatingActionButton(
              ...
              child:
                  Icon(Icons.mail_outline, color: theme.primaryIconTheme.color),
              onPressed: () => Stage.of(context)!
                  .showAlert(const ConfirmEmail(), size: ConfirmEmail.height),
            ),
          ],
        ),
      ),
