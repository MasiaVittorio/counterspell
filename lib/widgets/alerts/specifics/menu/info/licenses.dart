...
class AlertLicenses extends StatelessWidget {
  const AlertLicenses({super.key});

  static void showText(StageData stage, String text, String title) =>
      stage.showAlert(
          HeaderedAlert(
            '"$title" Package',
            child: Padding(
    ...
    return HeaderedAlert(
      ...
      bottom: ListTile(
        ...
        onTap: () => stage!.showAlert(
            const ConfirmAlert(
              warningText:
                  "You'll be redirected to your browser on CounterSpell's  github page",
        ...
        children: <Widget>[
          ...
          Section([
            ...
            ListTile(
              ...
              onTap: () =>
                  showText(stage!, CSLicenses.mit, "cached_network_image"),
            ),
            ListTile(
            ...
            ListTile(
              ...
              onTap: () =>
                  showText(stage!, CSLicenses.bsd, "flutter_reorderable_list"),
            ),
            ListTile(
