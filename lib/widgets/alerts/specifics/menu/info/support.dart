...
class _SupportAlertState extends State<SupportAlert> {
  ...
  Widget build(BuildContext context) {
    ...
    return pBloc.unlocked.build(
      (_, unlocked) => HeaderedAlert(
        refreshing
            ? "Refreshing data..."
            : unlocked
                ? "You are a pro!"
    ...
    return Column(
      ...
      children: <Widget>[
        const Padding(
          ...
          child: Text(
              "You can support the developer by making any donation from this list. If you do, you'll unlock all the \"pro\" features no matter the amount of the donation."),
        ),
        Row(
          children: <Widget>[
            Expanded(
      ...
      builder: (_, List<Donation>? donations, Set<String>? purchasedIds) =>
        ...
        children: <Widget>[
          for (final donation in donations!)
            _Donation(donation,
                purchased: purchasedIds!.contains(donation.productID))
        ],
      ),
    );
  }
    ...
    return HeaderedAlert(
      ...
      bottom: ListTile(
        ...
        onTap: () => Clipboard.setData(
            ClipboardData(text: CSBloc.of(context).payments.log)),
      ),
      child: Column(
        children: <Widget>[
          const Section([
            ...
            ListTile(
              title: Text(
                  "The amount of the money you donate doesn't matter. You can donate just the lowest possible amount and you'll get every pro feature unlocked. You can make bigger or multiple donations and you'll unlock the same stuff."),
            ),
          ]),
          const Section([
            ...
            ListTile(
              title: Text(
                  "At this moment, the pro features include the theme engine and the leaderboards. If you already made a donation and unlocked those, you will get any future \"pro\" feature if I ever add any."),
            ),
            SubSection(
              [
                ListTile(
          ...
          const Section([
            ...
            ListTile(
              title: Text(
                  "I made this app because I wanted to use it myself, and I feel like its core features should always stay free to anyone else who appreciate it like I do."),
            ),
            ListTile(
              title: Text(
                  "If you want to donate more than just the lowest amount you should do that because you appreciate my work, not to unlock the latest skin or stuff like that."),
            ),
            SubSection(
              [
                ListTile(
          ...
          Padding(
            padding:
                const EdgeInsets.only(right: 16.0, left: 16.0, bottom: 14.0),
            child: Text(
              FlavorTexts.rancor,
              style: TextStyle(
