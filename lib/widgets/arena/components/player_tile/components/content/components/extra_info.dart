...
class AptInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StageBuild.offMainEnabledPages<CSPage>(
      (_, enabledPages) => bloc.game.gameAction.counterSet.variable.build(
        (context, _) {
          final List<ExtraInfo> list = ExtraInfo.fromPlayer(
            name,
