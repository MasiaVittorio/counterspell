...
class AptName extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return bloc!.settings.arenaSettings.hideNameWhenImages.build(
      (_, hideNameWithImage) {
        bool hideName = hideNameWithImage &&
            (bloc!.game.gameGroup.cards(!usingPartnerB).value[name] != null);
