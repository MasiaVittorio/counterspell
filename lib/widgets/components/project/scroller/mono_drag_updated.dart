...
// everything taken from the flutter library but with a single crucial edit:

/// just like [PublicDragGestureRecognizer] but with [velocityTrackers] that are public goddamn
sealed class PublicDragGestureRecognizer extends OneSequenceGestureRecognizer {
  /// Initialize the object.
  ///
  /// {@macro flutter.gestures.GestureRecognizer.supportedDevices}
  PublicDragGestureRecognizer({
    super.debugOwner,
  ...
  /// {@template flutter.gestures.monodrag.PublicDragGestureRecognizer.multitouchDragStrategy}
  ...
  /// {@template flutter.gestures.monodrag.PublicDragGestureRecognizer.onStart}
  ...
  /// {@template flutter.gestures.monodrag.PublicDragGestureRecognizer.onUpdate}
  ...
  /// {@template flutter.gestures.monodrag.PublicDragGestureRecognizer.onEnd}
  ...
  ///
  /// To estimate the velocity of a gesture, [PublicDragGestureRecognizer] calls
  ...
  final Map<int, VelocityTracker> velocityTrackers = <int, VelocityTracker>{};
  ...
  void _addPointer(PointerEvent event) {
    velocityTrackers[event.pointer] = velocityTrackerBuilder(event);
    switch (_state) {
  ...
  void handleEvent(PointerEvent event) {
    ...
    if (!event.synthesized &&
      ...
      velocityTrackers[event.pointer]!.addPosition(event.timeStamp, position);
    }
...
class PublicPanGestureRecognizer extends PublicDragGestureRecognizer {
  /// Create a gesture recognizer for tracking movement on a plane.
  PublicPanGestureRecognizer({
    super.debugOwner,
    super.supportedDevices,
