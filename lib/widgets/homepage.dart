...
import 'package:counter_spell/widgets/stage/stageboard_components.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Stage<CSPage?, SettingsPage?>(
        ...
        collapsedPanel: const CSPanelCollapsed(
          key: WidgetsKeys.collapsed,
        ),
        extendedPanel: const CSPanelExtended(
          key: WidgetsKeys.extendedPanel,
        ),
        body: const CSBody(
          key: WidgetsKeys.body,
        ),
        topBarContent: StageTopBarContent(
          title: const CSTopBarTitle(
            key: WidgetsKeys.animatedAppTitle,
          ),
...
class _ScaffoldBackgroundFill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return stage.themeController.colorPlace.build(
      (_, place) => Container(
        color:
            place.isTexts ? theme.canvasColor : theme.scaffoldBackgroundColor,
      ),
    );
  }
}
