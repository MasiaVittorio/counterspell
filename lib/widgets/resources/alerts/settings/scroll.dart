...
class ScrollSensitivity extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final color = stage.themeController.light.value
      ? stage.themeController.panelPrimaryColor.value
      : Colors.white;
    ...
    return Theme(
      data: theme.copyWith(
        ...
        sliderTheme: theme.sliderTheme.copyWith(
          ...
          thumbColor: color,
          overlayColor: color.withAlpha(0x1f),
          inactiveTickMarkColor: color.withAlpha(0x3d),
          inactiveTrackColor: color.withAlpha(0x3d),
        ),
      ),
      child: Material(
