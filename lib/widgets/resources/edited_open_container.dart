// /// EDITED VERSION OF OPENCONTAINER FOR SUPPORTING COLORS 
// /// DIFFERENT THAN WHITE AS INTERMEDIATE STATE OF THE ANIMATION
...
//     this.intermediateColor = Colors.white,
...
//   /// to [intermediateColor] and then transition from there to [openColor] in one
//   /// smooth animation. When the container is closed, it will transition back to
//   /// this color from [openColor] via [intermediateColor].
//   ///
...
//       intermediateColor: widget.intermediateColor,
...
//     required Color intermediateColor,
//   }) {
...
//           <TweenSequenceItem<Color?>>[
//             TweenSequenceItem<Color?>(
//               tween: ColorTween(begin: closedColor, end: intermediateColor),
//               weight: 1 / 5,
//             ),
//             TweenSequenceItem<Color?>(
//               tween: ColorTween(begin: intermediateColor, end: openColor),
//               weight: 4 / 5,
//             ),
//           ],
//         );
