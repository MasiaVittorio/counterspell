...
class SnackCounterSelector extends StatelessWidget {
  const SnackCounterSelector({super.key});
  @override
  Widget build(BuildContext context) {
    ...
    return gameAction.counterSet.build(
      (_, current) => SelectSnackbar(
        autoClose: false,
        initialIndex: ordered.indexOf(current),
        children: <Widget>[for (final counter in ordered) Icon(counter.icon)],
