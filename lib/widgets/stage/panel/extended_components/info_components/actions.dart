...
// import 'package:counter_spell/widgets/other_routes/data_backup/backup_route.dart';

class CounterSpellActions extends StatelessWidget {
  const CounterSpellActions({super.key});
          ...
          ButtonTilesRow(
            ...
            children: <Widget>[
              ...
              ButtonTile.transparent(
                ...
                onTap: () => stage!.showAlert(const ContactsAlert(),
                    size: ContactsAlert.height),
              ),
            ],
          ),
        ],
