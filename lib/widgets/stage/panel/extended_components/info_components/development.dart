...
class Development extends StatelessWidget {
  const Development({super.key, required this.compact});
        ...
        ButtonTilesRow(
          children: [
            ButtonTile.transparent(
              ...
              onTap: () => stage.showAlert(const ConfirmDiscord(),
                  size: ConfirmDiscord.height),
            ),
            ButtonTile.transparent(
              text: "Telegram",
              icon: McIcons.telegram,
              onTap: () => stage.showAlert(const ConfirmTelegram(),
                  size: ConfirmTelegram.height),
            ),
            ButtonTile.transparent(
              text: "Email",
              icon: McIcons.gmail,
              onTap: () => stage.showAlert(const ConfirmEmail(),
                  size: ConfirmEmail.height),
            ),
          ],
        ),
      ]);
        ...
        children: [
          Highlightable(
            ...
            child: ButtonTile(
              ...
              text: "Changelog",
              onTap: () =>
                  stage.showAlert(const Changelog(), size: Changelog.height),
            ),
          ),
          ButtonTile(
            ...
            text: "Licenses",
            onTap: () =>
                stage.showAlert(const AlertLicenses(), size: DamageInfo.height),
          ),
          if (compact)
            ButtonTile(
              text: "Support",
