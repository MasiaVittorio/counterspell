...
class SettingsAppearance extends StatelessWidget {
  const SettingsAppearance({super.key, required this.compact});
        ...
        SubSection([
          ...
          ButtonTilesRow(
            ...
            children: <Widget>[
              ...
              if (compact) historyButton(showHistoryPicker),
            ],
          ),
        ]),
        ...
        (_, mode) => Column(
          ...
          children: [
            RadioSlider(
              ...
              items: [
                for (final timeMode in TimeMode.values)
                  RadioSliderItem(
            ...
            Padding(
              ...
              child: AnimatedText(
                {
                  TimeMode.clock:
                      "(Tells you that a change happened at: 21:45)",
                  TimeMode.inGame:
                      "(Tells you that a change happened 37 minutes into a game)",
