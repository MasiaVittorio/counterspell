      ...
      onSubmitted: (color) {
        ...
        bloc.themer.resolvableDefenceColor.set(
          bloc.themer.resolvableDefenceColor.value.copyWithState(
            color: color,
            isLight:
                bloc.stage.themeController.brightness.brightness.value.isLight,
            isFlat: bloc.stage.themeController.colorPlace.value.isTexts,
            darkStyle: bloc.stage.themeController.brightness.darkStyle.value,
          ),
        );
        stage.closePanel();
      },
