...
class ThemePResetter extends StatelessWidget {
  const ThemePResetter({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return BlocVar.build8(
      ...
      themeController.colorPlace,
      brightnessController.darkStyle,
      builder: (
        _,
        ...
        void save() => stage.showAlert(
              InsertAlert(
                initialText: () {
                  ...
                  final String seed2 =
                      derivedScheme.colorPlace.isTexts ? "Flat" : "Solid";
                ...
                checkErrors: (name) {
                  ...
                  if (CSColorScheme.defaults.keys.contains(name)) {
